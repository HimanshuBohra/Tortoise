...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Plan',
            fields=[
                ('planID', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
                ...
                ('status', models.SmallIntegerField(default=1, max_length=3)),
        ...
        migrations.CreateModel(
            name='Promotions',
            fields=[
                ('promotionID', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
